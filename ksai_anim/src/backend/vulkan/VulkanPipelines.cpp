...
namespace VulkanPipelines
{
    ...
    )
    {
        ...
        /* Create Graphics Pipeline */
        {
            ...
            vkDestroyShaderModule(vk_logical_device_, fragment_shader_module, nullptr);
        }
...
namespace VulkanPipelines
{
    auto createPipelineForShadow(vk_rsrs *rsrs, renderer_backend *backend, pipeline_vk *inPipeline, VkRenderPass rn_pass)
    {
