...
void extui_create_vulkan_pipeline(vk_rsrs* _rsrs, l_vlkn_ppln* ppln, int _descriptor_set_layout_binding_count, VkDescriptorSetLayoutBinding* _descriptor_layout_binding, const char* _vshader_path, const char* _fshader_path, VkVertexInputBindingDescription* _vertex_input_binding_description, int _vertex_input_binding_description_count, VkVertexInputAttributeDescription* _vertex_input_attribute_description, int _vertex_input_attribute_description_count, int _no_of_texture_images, VkImage* _texture_images, VkDeviceMemory* _texture_image_memory, VkSampler* _texture_image_sampler, VkImageView* _texture_image_view, const char** _texture_image_path, int _no_of_pool_sizes, VkDescriptorPoolSize* _pool_sizes, char staging_buffer_memory, int initial_size_factor);
void extui_create_vulkan_pipeline2(vk_rsrs* _rsrs, l_vlkn_ppln* ppln, int _descriptor_set_layout_binding_count, VkDescriptorSetLayoutBinding* _descriptor_layout_binding, const char* _vshader_path, const char* _fshader_path, VkVertexInputBindingDescription* _vertex_input_binding_description, int _vertex_input_binding_description_count, VkVertexInputAttributeDescription* _vertex_input_attribute_description, int _vertex_input_attribute_description_count, int _no_of_texture_images, VkImage* _texture_images, VkDeviceMemory* _texture_image_memory, VkSampler* _texture_image_sampler, VkImageView* _texture_image_view, const char** _texture_image_path, int _no_of_pool_sizes, VkDescriptorPoolSize* _pool_sizes);
void extui_create_vulkan_pipeline2_compute(vk_rsrs *_rsrs, l_vlkn_ppln *ppln, int _descriptor_set_layout_binding_count, VkDescriptorSetLayoutBinding *_descriptor_layout_binding, const char *_vshader_path, const char *_fshader_path, const char *_cshader_path, VkVertexInputBindingDescription *_vertex_input_binding_description, int _vertex_input_binding_description_count, VkVertexInputAttributeDescription *_vertex_input_attribute_description, int _vertex_input_attribute_description_count, int _no_of_texture_images, VkImage *_texture_images, VkDeviceMemory *_texture_image_memory, VkSampler *_texture_image_sampler, VkImageView *_texture_image_view, const char **_texture_image_path, int _no_of_pool_sizes, VkDescriptorPoolSize *_pool_sizes);
